...
echoes_of_death_two = {
    ...
    'memetic_symphony': {
        ...
        'expansion': 'echoes_of_death_2',
        'milestone_condition': (
            'During <font class="kdm_se_card">se</font> <b>Weird Dream</b>, '
            'a storyteller tells a Well Told account that includes a dreaming '
            "survivor hearing the Devil's Symphony."
        ),
    },
    'surgical_sight': {
        'name': "Surgical Sight",
...
santa_satan = {
    'atmospheric_change': {
        ...
        'permanent_effect': (
            ...
            "flakes of snow drift through the sky.<br/>Archive <b>Heat "
            "Wave</b> from the settlement event deck.<br/>Add <b>Lump of "
            "Atnas</b> basic resource to the basic resource deck."""
        ),
    },
}
